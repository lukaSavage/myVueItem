    ...
    <div>
        <section class="profile">
            ...
            <section class="profile-number">
                <!-- 这里的路由需要判断，如果没有_id,要去的是登录界面/login,如果有，应该去/userInfo -->
                <a
                    href="javascript:"
                    class="profile-link"
            ...
            <section class="profile_my_order border-1px">
                <mt-button type="danger" style="width:100%" v-show="user._id" @click="logout">退出</mt-button>
            </section>
        </section>
    </div>
</template>
