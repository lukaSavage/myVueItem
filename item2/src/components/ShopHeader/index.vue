            ...
            <div class="shop-brief-modal" v-show="isShowBulletin">
                <div class="brief-modal-content">
                    ...
                    <div class="mask-footer">
                        <span class="iconfont icon-close" @click="isShowBulletin=!isShowBulletin"></span>
                    </div>
                </div>
        ...
        <transition name="remove">
            <div class="activity-sheet" v-show="isShowSupports">
                <div class="activity-sheet-content">
                    ...
                    <div class="activity-sheet-close" @click="isShowSupports=!isShowSupports">
                        <span class="iconfont icon-close"></span>
                    </div>
                </div>
                <div class="activity-sheet-cover" @click="isShowSupports=!isShowSupports"></div>
            </div>
        </transition>
    </div>
</template>
...
export default {
    ...
    data() {
        return {
            isShowBulletin: false, // 是否展示商铺信息
            isShowSupports: false, // 是否展示活动信息
